...
public record EpicFightBootsStats(float weight, float stunArmor) implements IMaterialStats {
    public static final MaterialStatsId ID = new MaterialStatsId(EpicFightTinkerCompat.MODID, "plating_boots");
    public static final MaterialStatType<EpicFightBootsStats> TYPE = new MaterialStatType<>(
        ID, 
        new EpicFightBootsStats(0f, 0f),
        RecordLoadable.create(
            FloatLoadable.ANY.defaultField("weight", 0f, true, EpicFightBootsStats::weight),
            FloatLoadable.ANY.defaultField("stun_armor", 0f, true, EpicFightBootsStats::stunArmor),
            EpicFightBootsStats::new
        )
    );
    ...
    @Override
    public MaterialStatType<EpicFightBootsStats> getType() {
        return TYPE;
    }
